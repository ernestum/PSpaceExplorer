...
* range search, and nearest neighbor(s) using long-precision longing-point
...
public class KDTree<T> {
	 ...
	 */
	public T[] nearest(double[] key, int n) {
	...
	public Object[] range(double[] lowk, double[] uppk) {
		if (lowk.length != uppk.length || lowk.length != m_K) {
			throw new IllegalArgumentException("KDTree: wrong key size!");
		}
